...
/**
 * Java Data Encryption Standard 資料加密標準，密鑰長度預設為 56 byte。
 * <p>
 ...
 * @author Skye
 */
public class JavaDESExampleTest {
	private String data = null;

	@Before
	public void setUp() {
		data = "Hello Java Data Encryption Standard.";
	}
	...
	public void testEncrypt() {
		System.out.println("-- JAVA DES Start --");
		...
		try {
			byte[] key = JavaDESExample.initKey();
			System.out.println("Key\t：" + Base64.encodeBase64String(key));

			encodeData = JavaDESExample.encrypt(data.getBytes(), key);
			System.out.println("EncodeData\t："
					+ Base64.encodeBase64String(encodeData));

			decodeData = JavaDESExample.decrypt(encodeData, key);
		...
		System.out.println("-- JAVA DES End --");
		System.out.println();
	}
}
